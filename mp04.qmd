...
```{r}
# Example probabilities (make sure to replace with actual computed values)
exhausted_savings_probability <- 0.25  # Example value, replace with your result
higher_income_probability <- 0.40      # Example value, replace with your result

# Create the summary results data frame
